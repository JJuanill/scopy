...
create_appdir(){
	...
	cp -r /lib/python3.9 $APP_DIR/usr/lib
	...
	cp /usr/lib/x86_64-linux-gnu/libGLESv2.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libstdc++.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libc.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libdl.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libpthread.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libXdmcp.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libgcc_s.so* $APP_DIR/usr/lib

	cp /usr/lib/x86_64-linux-gnu/libm.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libbsd.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libXau.so* $APP_DIR/usr/lib
	cp /usr/lib/x86_64-linux-gnu/libxcb.so* $APP_DIR/usr/lib
	popd
}
